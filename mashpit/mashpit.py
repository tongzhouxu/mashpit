...
def commandToArgs(commandline):
    ...
    subparser_query = subparsers.add_parser("query", help='Query for the most similar isolates')
    subparser_webserver = subparsers.add_parser("webserver", help='Start a local web server')

    # arguments for mashpit build
    subparser_build.add_argument("type", type=str, help="mashpit database type.",choices=['taxon', 'accession'])
    ...
    subparser_build.add_argument("--number", type=int,default=1000,help="maximum number of hashes for sourmash, default is 1000")
    subparser_build.add_argument("--ksize", type=int,default=31,help="kmer size for sourmash, default is 31")
    ...
    subparser_build.add_argument("--pd_version",type=str,help='a specified Pathogen Detection version (PDG accession). Default is the latest.')
    subparser_build.add_argument("--list",type=str,help='Path to a list of NCBI BioSample accessions')
    ...
    subparser_update.add_argument(dest="database", type=str, help="path for the database folder")
    subparser_update.add_argument(dest="name", type=str, help="database name")
    subparser_update.add_argument("--metadata", type=str, help="metadata file in csv format")
